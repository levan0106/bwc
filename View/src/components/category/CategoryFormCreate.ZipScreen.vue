        ...
        <bwc-loading :loading="loading">    
            <el-row :gutter="20">
                ...
                <el-col :span="6"> 
                    ...
                    <el-form-item label="Tube Type" >
                        <bwc-input-number v-model="form.TubeType" 
                        auto-complete="off"
                        controls-position="right"
                        class="input-number-fs"
                        ></bwc-input-number>
                ...
                <el-col :span="6"> 
                    <el-form-item label="Outer Track (Drop -)" >
                        <bwc-input-number v-model="form.OuterTrackDrop" 
                        auto-complete="off"
                        controls-position="right"
                        class="input-number-fs"
                        ></bwc-input-number>
                    </el-form-item>
                    <el-form-item label="Inner Track (Drop -)" >
                        <bwc-input-number v-model="form.InnerTrackDrop" 
                        auto-complete="off"
                        controls-position="right"
                        class="input-number-fs"
                        ></bwc-input-number>
                    </el-form-item>
                    <el-form-item label="Material + Keder (width -)" >
                        <bwc-input-number v-model="form.MaterialKederWidth" 
                        auto-complete="off"
                        controls-position="right"
                        class="input-number-fs"
                        ></bwc-input-number>
